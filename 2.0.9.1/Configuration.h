...
#define STRING_CONFIG_H_AUTHOR "(stream2me, Ender-3)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 31.7060
    #define DEFAULT_Ki 2.7450
    #define DEFAULT_Kd 91.5550
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 136.9958
  #define DEFAULT_bedKi 26.9730
  #define DEFAULT_bedKd 463.8679
...
#define TOUCH_MI_PROBE
  ...
  #define TOUCH_MI_RETRACT_Z 0.20                  // Height at which the probe retracts
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -6, -6.115 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_USE_PROBE
    ...
    #undef LEVEL_CORNERS_INSET_LFRB
 ...
 */
//#define Z_PROBE_END_SCRIPT "G0 X100 Y0 Z40 F10000\nM300 P200\nG4 P400\nM300 P200\nG4 P400\nM300 P200\nG4 P400\nM300 P200\nG4 P400\nM300 P200\nM0 REMOVE KEY PROBE\nG1 X0 Y0 Z30 F5000"
