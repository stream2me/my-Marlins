...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_MIN    130 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
  #define CONTROLLERFAN_SPEED_ACTIVE 255 // (0-255) Active speed, used when any motor is enabled
  #define CONTROLLERFAN_SPEED_IDLE     130 // (0-255) Idle speed, used when motors are disabled
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LCD_TIMEOUT_TO_STATUS 50000
  ...
  #define EVENT_GCODE_SD_ABORT "G28XY\nG92 E0\nG1 E-4 F1800"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
